...
// The upload logic will go here next...
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Admin Panel'), // Title changed to 'Admin Panel'
      ),
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                // --- START ORDER MANAGEMENT BUTTON ---
                ElevatedButton.icon(
                  icon: const Icon(Icons.shopping_bag),
                  label: const Text('Manage All Orders', style: TextStyle(fontSize: 16)),
                ...
                // --- START PRODUCT MANAGEMENT HEADER ---
                const Text(
                  'Add New Product',
                ...
                // 4. The "Image URL" text field (Your existing product form starts here)
                TextFormField(
